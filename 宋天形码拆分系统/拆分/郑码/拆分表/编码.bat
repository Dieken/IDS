...
set im=..
set charset=..\..\..\字集
set "code=..\..\divide -f -zm -s:GX -tcs:\0 %base%\汉字拆分.txt %base%\汉字补充拆分.txt -p:%base%\部件拆分.txt -p:%base%\部件补充拆分.txt %im%\郑码汉字拆分.txt -p:%im%\郑码部件拆分.txt -rd:%im%\郑码字根表.txt -sc:%im%\郑码简码表.txt"
