...
set im=..
set charset=..\..\..\字集
set "code=..\..\divide -f -s:GX %base%\汉字拆分.txt %base%\汉字补充拆分.txt -p:%base%\部件拆分.txt -p:%base%\部件补充拆分.txt %im%\092汉字拆分.txt -p:%im%\092部件拆分.txt -rd:%im%\092字根表.txt -sc:%im%\092简码表.txt"
